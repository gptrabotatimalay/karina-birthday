...
export default class KitchenScene extends Phaser.Scene {
    ...
    createDialogWindow(bgWidth, bgHeight) {
        ...
        this.addChatMessage('Карина', 'Вот я и на кухне!', '#00ffff');
            ...
            if (this.drawStart) {
                ...
                if (width > 5 && height > 5) {
                    ...
                    if (this.drawMode === 'walls') {
                        ...
                        // Создаем стену напрямую (без дополнительного смещения)
                        ...
                        // Создаем зону напрямую (без дополнительного смещения)
            ...
            if (this.isBathroomUnlocked) {
                ...
                const bathroomKeypad = new DoorKeypad(
                    ...
                    () => {
                        ...
                        this.addChatMessage('Карина', 'Ура! Дверь открылась! 🚪', '#00ff00');
        ...
        switch(zoneName) {
            case 'stove':
                ...
                this.ovenOverlay.open(() => {
                    ...
                    this.isInteracting = false;
                    this.addChatMessage('Карина', 'М-м-м, как вкусно пахнет! 🍗', '#ffaa00');
                });
                break;
            case 'kettle':
                ...
                this.addChatMessage('Карина', 'Включила чайник! Сейчас закипит...', '#00ffff');
                ...
                this.kettleAudio.once('complete', () => {
                    ...
                    this.addChatMessage('Карина', 'Вскипел! ☕️', '#00ff00');
            ...
            case 'wash_dishes':
                ...
                this.dishWashing.open(() => {
                    ...
                    this.isInteracting = false;
                    this.addChatMessage('Карина', 'Ух! Отмыла до блеска! ✨', '#00ff00');
                });
                break;
            case 'feed_reksi':
                ...
                this.time.delayedCall(6000, () => {
                    ...
                    // Сообщение в чат
                    this.addChatMessage('Карина', 'Рекси! Кушать подано! Идем кушать!', '#ffaa00');
            ...
            case 'fridge':
                ...
                this.fridgeOverlay.open(() => {
                    ...
                    this.isInteracting = false;
                    this.addChatMessage('Карина', 'Хорошая коллекция магнитиков! 🌍', '#00ffff');
                });
                break;
            case 'kitchen_table':
                ...
                if (randomChoice) {
                    ...
                    // Сообщение в чат
                    this.addChatMessage('Карина', 'Последняя чипсина — самая вкусная.', '#ffaa00');
                } else {
                    // Вариант Б: огурчики
                    ...
                    // Сообщение в чат
                    this.addChatMessage('Карина', 'М-м-м... С солеными огурчиками!', '#ffaa00');
                }
                break;
        }
    }
